...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../almacenista/home.php">Inicio</a></li>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              <?php
              // Muestra la imagen del perfil del usuario si está disponible
              if (!empty($foto)) {
                echo "<img src='../imgpro/$img' alt='Profile' class='rounded-circle' width='120px' height='120px'>";
              } else {
