...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="../database/cerrar.php">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="../almacenista/home.php">
          <i class="bi bi-grid"></i>
          <span>Inicio</span>
        </a>
      </li><!-- End Dashboard Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed " href="../almacenista/categorias.php">
          <i class="bi bi-inboxes"></i>
          <span>Categorias</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed " href="../almacenista/productos.php">
          <i class="bi bi-box-seam"></i>
          <span>Productos</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed " href="baja.php">
          <i class="bi bi-box-arrow-in-down"></i>
          <span>Productos de baja</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed " href="../almacenista/compras.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed " href="requi.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../database/cerrar.php">
          <i class="bi bi-box-arrow-right"></i>
          <span>Cerrar Sesión</span>
        </a>
      </li><!-- End Contact Page Nav -->
